export const profile = {
  name: 'Jenny Tang',
  role: 'Media Operations Analyst · Marketing Analytics · Programmatic Optimization · AI Workflow Automation',
  ...
  industries: 'Fintech · Financial Services · Web3 · Education · Retail',
  contact: {
